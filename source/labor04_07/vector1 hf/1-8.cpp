/*
	...
	Drill 1
	Define struct Item { string name; int iid; double value; }; , make a 
	vector<Item>, vi, and fill it with ten items from a file.
	...
	Drill 7
	Remove (erase) two Items identified by ID from vi.
...
void fct()
{
	...
	v.insert(v.begin() + 2, Item{ "horse shoe", 12.34, 99 });
	v.insert(v.begin() + 7, Item{ "Canon S400", 499.95, 9988 });
	for (Item i : v)
		cout << i << endl;
